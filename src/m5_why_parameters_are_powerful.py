...
def main():
    ...
    # -------------------------------------------------------------------------
    even_better_draw_circles(rg.Point(100, 50),20,5,'blue',5)
    better_draw_circles(rg.Point(-50, 100), 5)
    even_better_draw_circles(rg.Point(20, 30), 2, 7, 'gray', 6)
    even_better_draw_circles(rg.Point(20, 30), 30, 350, 'yellow', 90)
...
def better_draw_circles(point,a):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        p = k * a
        turtle.draw_circle(p)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point,a,num,col,thi):
